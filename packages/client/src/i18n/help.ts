...
Discard Hu: discarder pays hand value.`,
  ...
  'htp.fan.Root':
    'Each four-of-a-kind split across two or more sets — a pung plus the fourth tile inside a chow, or two pairs of a seven-pairs hand. All four in one set is a kong instead.',
...
点炮胡：点炮者支付 番值。`,
  ...
  'htp.fan.Root':
    '同一种牌四张分在两组或以上，每有一组计一番——刻子加顺子里的第四张，或七对中算作两对的四张。四张同在一组则是杠，不算根。',
...
點炮胡：點炮者支付 番值。`,
  ...
  'htp.fan.Root':
    '同一種牌四張分在兩組或以上，每有一組計一番——刻子加順子裡的第四張，或七對中算作兩對的四張。四張同在一組則是槓，不算根。',
...
Hu sur défausse : le joueur qui a défaussé paie la valeur de la main.`,
  ...
  'htp.fan.Root':
    'Chaque carré réparti sur deux combinaisons ou plus — un pung plus la quatrième tuile dans une suite, ou les deux paires d’une main de sept paires. Les quatre dans une seule combinaison forment un kong.',
...
Hu por descarte: paga solo quien descartó, el valor de la mano.`,
  ...
  'htp.fan.Root':
    'Cada cuarteto repartido entre dos o más combinaciones — un pung más la cuarta ficha dentro de una escalera, o las dos parejas de una mano de siete parejas. Las cuatro en una sola combinación son un kong.',
...
ロンアガリ：放銃者だけが点数を支払います。`,
  ...
  'htp.fan.Root':
    '同じ牌4枚が2つ以上の面子に分かれているごとに1翻 — 刻子と、順子に入った4枚目。七対子で2対として数える4枚も同じです。4枚が1つの面子に収まっていれば槓になります。',
