...
- [ ] **Deploy to Render.** Everything the deploy needs is built and merged
  (C1–C7, C9; C8 is deliberately off for the free tier). What remains is running
  the Blueprint and watching the first real game over the proxy — steps and the
  post-deploy checklist are in
